...
#ifndef MOTHERBOARD
  #define X_MAX_PIN  PF2 // creality connects X_MAX switch to X_MIN(_PIN) motherbard connector
  #define Y_MAX_PIN PC13 // creality connects Y_MAX switch to Y_MIN(_PIN) motherbard connector
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 800, 93.02 }
